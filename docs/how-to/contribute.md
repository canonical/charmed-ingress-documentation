...
myst:
  html_meta:
    "description lang=en": "Learn how to contribute to the Charmed Ingresses documentation."
---
...
```{note}
See [CONTRIBUTING.md](https://github.com/canonical/charmed-ingress-documentation/blob/main/CONTRIBUTING.md)
for information on contributing to the source code.
```

Our documentation is stored in the `docs` directory alongside the [source code on GitHub](https://github.com/canonical/charmed-ingress-documentation/).
...
[file a bug](https://github.com/canonical/charmed-ingress-documentation/issues) to provide constructive feedback or suggestions.
